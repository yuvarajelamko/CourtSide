...
class GamesContainer2 extends StatefulWidget {

  final int numberOfColumn;
  const GamesContainer2({super.key, required this.numberOfColumn});

  @override
  _GamesContainerState2 createState() => _GamesContainerState2();
}

class _GamesContainerState2 extends State<GamesContainer2> {
  String apiKey =
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.numberOfColumn == 4) {
      for (int i = 0; i < dataLength; i++) {
        if (jsonData['series'][i]['round'] == 2) {
          homeAlias =
