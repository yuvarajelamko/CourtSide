          ...
          children: [
            Expanded(
              child: Container(
                ...
                child: Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Image.asset('assets/team/$homeAlias.png',width: 100, height: 100,),
                    Text(homeMarket ?? '', style: TextStyle(color: Colors.black)), // + homeName
            ...
            Expanded(
              child: Container(
                ...
                child: Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Image.asset('assets/team/$awayAlias.png',width: 100, height: 100,),
                    Text(awayMarket ?? '', style: TextStyle(color: Colors.black)), // + homeName
