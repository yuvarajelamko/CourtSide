...
class GamesContainer3 extends StatefulWidget {

  final int numberOfColumn;
  GamesContainer3({required this.numberOfColumn});

  @override
  _GamesContainerState3 createState() => _GamesContainerState3();
}

class _GamesContainerState3 extends State<GamesContainer3> {
  String apiKey =
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.numberOfColumn == 2) {
      for (int i = 0; i < dataLength; i++) {
        if (jsonData['series'][i]['round'] == 3) {
          homeAlias =
